...
//
//  // this, ideally, would be its own controller initialized by FXML. however, talking to
// controllers
//  // managed by FXML
...
//        createTableColumn(
//            "Start Node ID", EdgePropertyAdapter::startNodeProperty, new
...
//
//    //noinspection unchecked
//    locationNameTableView.getColumns().setAll(longNameColumn, shortNameColumn,
// locationTypeColumn);
