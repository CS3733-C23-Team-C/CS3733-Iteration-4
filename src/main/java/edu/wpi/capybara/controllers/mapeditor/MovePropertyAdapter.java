...
public class MovePropertyAdapter {
    private static final JavaBeanStringPropertyBuilder nodeIDBuilder = JavaBeanStringPropertyBuilder.create().name("nodeid");
    private static final JavaBeanStringPropertyBuilder longNameBuilder = JavaBeanStringPropertyBuilder.create().name("longname");
    private static final JavaBeanObjectPropertyBuilder<Date> moveDateBuilder = JavaBeanObjectPropertyBuilder.create().name("movedate");
    ...
    public MovePropertyAdapter(move mv) {
        try {
            ...
            throw new IllegalStateException("Unable to find getters/setters on move. This should not be possible.", e);
        }
    }
