...
public class BestFSPathfinder implements PathfindingAlgorithm {
    ...
    private List<NodeEntity> bestfs(NodeEntity start, NodeEntity goal,PathfindingCost costAlgorithm) {

        LinkedList<BestFSPathfinder.BestFSPathNode> queue = new LinkedList<BestFSPathfinder.BestFSPathNode>();
