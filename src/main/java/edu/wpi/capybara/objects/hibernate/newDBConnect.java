...
public class newDBConnect implements RepoFacade {
    ...
    void importAudio(){
        ...
        HashMap<Integer, AudiosubmissionEntity> ret =
                new HashMap<Integer, AudiosubmissionEntity>();
    ...
    void importLocationname(){
        ...
        HashMap<String, LocationnameEntity> ret =
                new HashMap<String, LocationnameEntity>();
    ...
    void importNode(){
        ...
        HashMap<String, NodeEntity> ret =
                new HashMap<String, NodeEntity>();
    ...
    void importStaff(){
        ...
        HashMap<String, StaffEntity> ret =
                new HashMap<String, StaffEntity>();
    ...
    void importEdge(){
        ...
        ArrayList<EdgeEntity> ret =
                new ArrayList<EdgeEntity>();
    ...
    void importMove(){
        ...
        ArrayList<MoveEntity> ret =
                new ArrayList<MoveEntity>();
