...
public class ComputersubmissionEntity extends SubmissionAbs implements Persistent, CSVExportable {
  ...
  public static class Importer implements CSVImporter<ComputersubmissionEntity> {
    @Override
    public ComputersubmissionEntity fromCSV(String[] csv) {
      ...
      return new ComputersubmissionEntity(
          submissionid,
          employeeid,
          assignedid,
          location,
